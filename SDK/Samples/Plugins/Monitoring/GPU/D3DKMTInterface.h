// D3DKMTInterface.h: interface for the CD3DKMTInterface class.
//
// created by Unwinder
//////////////////////////////////////////////////////////////////////
#ifndef _D3DKMTINTERFACE_H_INCLUDED_
#define _D3DKMTINTERFACE_H_INCLUDED_
//////////////////////////////////////////////////////////////////////
#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
...
//////////////////////////////////////////////////////////////////////
#define STATUS_NOT_IMPLEMENTED           ((MYNTSTATUS)0xC0000002L)
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
typedef struct _D3DKMT_QUERYSTATISTICS_VISTA
{
...
} D3DKMT_QUERYSTATISTICS_VISTA;
//////////////////////////////////////////////////////////////////////
typedef struct _D3DKMT_STATISTICS_VISTA
{
	DWORD							Reserved[1024];
} _D3DKMT_STATISTICS_VISTA;
//////////////////////////////////////////////////////////////////////
...
typedef MYNTSTATUS (APIENTRY *D3DKMTOPENADAPTERFROMGDIDISPLAYNAME)(D3DKMT_OPENADAPTERFROMGDIDISPLAYNAME*);
typedef MYNTSTATUS (APIENTRY *D3DKMTCLOSEADAPTER)(D3DKMT_CLOSEADAPTER*);
typedef MYNTSTATUS (APIENTRY *D3DKMTQUERYSTATISTICS)(LPVOID);
//////////////////////////////////////////////////////////////////////
class CD3DKMTInterface  
{
public:
	MYNTSTATUS D3DKMTOpenAdapterFromDeviceName(D3DKMT_OPENADAPTERFROMDEVICENAME* pData);
	MYNTSTATUS D3DKMTOpenAdapterFromGdiDisplayName(D3DKMT_OPENADAPTERFROMGDIDISPLAYNAME* pData);
	MYNTSTATUS D3DKMTCloseAdapter(D3DKMT_CLOSEADAPTER* pData);
	MYNTSTATUS D3DKMTQueryStatistics(LPVOID pData);

	BOOL Init();
	void Uninit();

	CD3DKMTInterface();
	virtual ~CD3DKMTInterface();

protected:
	HINSTANCE m_hGDI32_DLL;

	D3DKMTOPENADAPTERFROMDEVICENAME		m_pD3DKMTOpenAdapterFromDeviceName;
	D3DKMTOPENADAPTERFROMGDIDISPLAYNAME	m_pD3DKMTOpenAdapterFromGdiDisplayName;
	D3DKMTCLOSEADAPTER					m_pD3DKMTCloseAdapter;
	D3DKMTQUERYSTATISTICS				m_pD3DKMTQueryStatistics;
};
//////////////////////////////////////////////////////////////////////
#endif
//////////////////////////////////////////////////////////////////////
